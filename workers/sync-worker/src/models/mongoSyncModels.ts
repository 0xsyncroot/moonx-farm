...
export interface ISyncOperation extends Document {
  operationId: string; // UUID for tracking sync operations
  userId: string;
  walletAddress: string;
...
// NOTE: Indexes are now managed by MongoSyncService.createIndexes() method
// This provides better control with named indexes and optimized compound indexes
// See: workers/sync-worker/src/services/mongoSyncService.ts
